...
<div class="container max-w-3xl mx-auto bg-white rounded-xl shadow-lg p-10 mt-10">
  ...
  <?= form_open('admin/election/save', ['id' => 'electionForm']) ?>
    <div class="mb-4">
    ...
    <div class="mb-4">
      <label for="semester" class="font-semibold mb-1 block">Semester:</label>
      <?= form_dropdown('semester', [
        '1st Semester' => '1st Semester',
        '2nd Semester' => '2nd Semester'
      ], isset($election['semester']) ? $election['semester'] : '', [
        'class' => 'form-select px-4 py-2 rounded-md w-full border',
        'id' => 'semester',
        'required' => true
      ]) ?>
    </div>
    ...
    <div class="flex flex-col md:flex-row gap-4 mt-6">
      <div class="flex-1">
        <button type="submit" name="action" value="set" class="btn btn-success w-full bg-green-700 hover:bg-green-800 text-white rounded-lg py-3 font-semibold">
          Set Election Start and End Time
        </button>
      </div>
      <div class="flex-1">
        <button type="submit" name="action" value="update" class="btn btn-success w-full bg-green-700 hover:bg-green-800 text-white rounded-lg py-3 font-semibold">
          Update Election Date and Time
        </button>
      </div>
    </div>
  <?= form_close() ?>
