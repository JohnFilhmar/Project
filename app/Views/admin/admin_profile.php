<div class="self-center bg-white bg-opacity-90 rounded-lg shadow-xl p-8 w-full max-w-md flex flex-col items-center mt-12 md:mt-20">
  <h2 class="text-2xl md:text-3xl font-bold mb-2 text-center">ADMIN Profile</h2>
  <div class="relative mb-4">
    <img src="<?= esc($profile_image_url) ?>" alt="Profile Image" class="w-40 h-40 object-cover rounded-lg border-4 border-green-500 shadow-md" />
  ...
  <div class="text-center mb-4">
    <p class="text-lg font-semibold"><?= esc($fullname) ?></p>
    <p class="text-base font-medium">Organization:</p>
    <p class="text-base"><?= esc($organization) ?></p>
    <p class="text-base font-medium">Email:</p>
    <p class="text-base"><?= esc($email) ?></p>
  </div>
